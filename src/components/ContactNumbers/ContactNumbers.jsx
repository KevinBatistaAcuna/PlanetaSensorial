      ...
      <div className='sectionNums__divContainer'>
          <div className='sectionNums__textContainer'>
            ...
            <div className='redesContainer'>
              <a href=""><img src='src\assets\instagram-logo.png' className='redesImages' alt='instagram'/></a>
              <a href=""><img src='src\assets\Facebook_Logo.png' className='redesImages' alt='facebook'/></a>
              <a href=""><img src='src\assets\whatsapp-logo.png' className='redesImages' alt='whatsap'/></a>
            </div>
          </div> 
