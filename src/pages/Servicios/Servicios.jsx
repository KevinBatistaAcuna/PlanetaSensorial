  ...
  return (
    <div>
        ...
        <section>
            ...
            <TextImg borderRadius={'53% 47% 17% 83% / 48% 11% 89% 52%'} clickable={true} route="terapiaOcupacional" classSelected={'light'} orientationImg={'left'} img={imgTerapia} title='Terapia ocupacional' content='Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae maxime reiciendis necessitatibus, ab nemo repellat sit quas earum eligendi, numquam impedit expedita aperiam perspiciatis, minima quaerat obcaecati eius beatae veritatis!'/>
            <TextImg borderRadius={'53% 47% 53% 47% / 14% 32% 68% 86%'} clickable={true} route="terapiaLenguaje" classSelected={'noLight'} orientationImg={window.screen.width < 770 ? 'left' : 'right'} img={imgTerapia} title='Terapia de lenguaje' content='Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae maxime reiciendis necessitatibus, ab nemo repellat sit quas earum eligendi, numquam impedit expedita aperiam perspiciatis, minima quaerat obcaecati eius beatae veritatis!'/>
