...
export default function Servicios() {
  return (
    <div>
        ...
        <section>
            <TextImg borderRadius={'30% 70% 29% 71% / 45% 13% 87% 55%'} clickable={true} classSelected={'noLight'} orientationImg={window.screen.width < 770 ? 'left' : 'right'} img={imgTerapia} title='Terapia fisica' content='Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae maxime reiciendis necessitatibus, ab nemo repellat sit quas earum eligendi, numquam impedit expedita aperiam perspiciatis, minima quaerat obcaecati eius beatae veritatis!'/>
            <TextImg borderRadius={'53% 47% 17% 83% / 48% 11% 89% 52%'} clickable={true} classSelected={'light'} orientationImg={'left'} img={imgTerapia} title='Terapia fisica' content='Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae maxime reiciendis necessitatibus, ab nemo repellat sit quas earum eligendi, numquam impedit expedita aperiam perspiciatis, minima quaerat obcaecati eius beatae veritatis!'/>
            <TextImg borderRadius={'53% 47% 53% 47% / 14% 32% 68% 86%'} clickable={true} classSelected={'noLight'} orientationImg={window.screen.width < 770 ? 'left' : 'right'} img={imgTerapia} title='Terapia fisica' content='Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae maxime reiciendis necessitatibus, ab nemo repellat sit quas earum eligendi, numquam impedit expedita aperiam perspiciatis, minima quaerat obcaecati eius beatae veritatis!'/>
            <TextImg borderRadius={'15% 85% 53% 47% / 89% 21% 79% 11%'} clickable={true} classSelected={'light'} orientationImg={'left'} img={imgTerapia} title='Terapia fisica' content='Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae maxime reiciendis necessitatibus, ab nemo repellat sit quas earum eligendi, numquam impedit expedita aperiam perspiciatis, minima quaerat obcaecati eius beatae veritatis!'/>
        </section>
    </div>
  )
}
