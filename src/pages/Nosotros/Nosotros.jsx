...
function Nosotros() {
  ...
  return (
    <div>
      ...
      <TextsNosotros classSelected={'noLight'} title='Nuestra Misión' content='Nuestra misión es proporcionar servicios clínicos y educativos de alta calidad a personas con diversas necesidades para ayudarles a desarrollar su máximo potencial e integrarse plenamente en la comunidad. Trabajamos en estrecha colaboración con las familias y terapeutas para brindar soluciones personalizadas a cada paciente.'/>
      <TextsNosotros classSelected={'light'} title='Nuestra Visión' content='Nuestra visión es convertirnos en el principal centro de terapias para personas con diversas necesidades, incluyendo dificultades de aprendizaje, retraso psicomotor, déficit de atención e hiperactividad en estudiantes de preescolar y primaria, así como niños con discapacidades. Promovemos el desarrollo saludable y un fuerte apoyo tanto para los niños como para sus familias, generando un impacto positivo tanto en el aspecto médico como en el social.'/>
      <Lists classSelected={'noLight'} title='Nuestros Objetivos' content={objetivosList}/>
      <Lists classSelected={'light'} title='Nuestros Principios y Valores' content={principiosList}/>
