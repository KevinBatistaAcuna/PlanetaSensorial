...
function Nosotros() {
  ...
  return (
    <>
      ...
      <TextsNosotros img={img2} borderRadius={'53% 47% 53% 47% / 14% 32% 68% 86%'} orientationImg={window.screen.width < 768 ? 'left' : 'right'}classSelected={'noLight'} title='Nuestra Misión' content='Nuestra misión es proporcionar servicios clínicos y educativos de alta calidad a personas con diversas necesidades para ayudarles a desarrollar su máximo potencial e integrarse plenamente en la comunidad. Trabajamos en estrecha colaboración con las familias y terapeutas para brindar soluciones personalizadas a cada paciente.'/>
      ...
      <Lists img={img4} orientationImg={window.screen.width < 768 ? 'left' : 'right'} borderRadius={'85% 15% 60% 40% / 51% 55% 45% 49%'} classSelected={'noLight'} title='Nuestros Objetivos' content={objetivosList}/>
